...
cc.Class({
    ...
    onCollisionEnter: function (other, self) {
         ...
         {
             this.s1.active =true;
             this.s1.position = cc.p((a.x + 50),(a.y + 200));
             this.gainScore();
             this.gainScore();
             return;
         }
        ...
        if(other.node.group === '3'){
            this.great.active =true;
            this.great.position = cc.p((a.x + 50),(a.y + 200));
            this.gainScore();
            this.gainScore();
            this.gainScore();
            this.gainScore();
        ...
        if(other.node.group === '4'){
            this.m1.active =true;
            this.m1.position = cc.p((a.x + 50),(a.y + 200));
            this.score += -2;
            this.scoreDisplay.string =   this.score.toString();
            return;
        }
